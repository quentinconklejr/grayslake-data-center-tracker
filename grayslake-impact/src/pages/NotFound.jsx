...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center">
      <div className="mb-6 w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
      ...
      <p className="text-xs font-mono text-blue-400/70 tracking-widest uppercase mb-3">404</p>
      <h1 className="text-2xl font-display font-semibold text-gray-100 mb-2">Page not found</h1>
