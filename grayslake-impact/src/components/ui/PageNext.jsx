...
export default function PageNext({ to, label, desc, color = 'text-blue-700', hoverBorder = 'hover:border-blue-300' }) {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-16 mb-8">
      ...
      <Link
        to={to}
        className={`group flex items-center justify-between gap-4 bg-white border border-gray-200 ${hoverBorder} rounded-xl px-6 py-5 hover:shadow-sm transition-all duration-150`}
      >
