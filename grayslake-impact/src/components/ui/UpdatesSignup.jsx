    ...
    <section className="border border-slate-300 rounded-xl bg-slate-50 overflow-hidden my-8">
      <div className="px-5 sm:px-6 py-5">
        ...
        <p className="text-sm text-slate-700 leading-relaxed mt-1.5 max-w-2xl">
          New filings, new documents, corrections to figures already published. Sent when there is
          something worth sending, which is not often. Your address is used for this and nothing
          else, and one line in reply takes you off the list.
        </p>
