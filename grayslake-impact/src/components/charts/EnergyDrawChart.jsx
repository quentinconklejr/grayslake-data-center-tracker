      ...
      <div ref={ref} className="space-y-8">
        ...
        <div className="flex items-end justify-between gap-4 pb-6 border-b border-edge-soft">
          <div>
            ...
            <p className="text-4xl sm:text-5xl font-display font-bold text-gray-900 tracking-tight break-words">1,600 <span className="text-2xl text-gray-400">MW</span></p>
          </div>
