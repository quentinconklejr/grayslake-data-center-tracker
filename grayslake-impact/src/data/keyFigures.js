...
export const keyFigures = [
  ...
  },
  {
    ...
    // Was `$8.5–18B`. An en dash asserts a span, and the detail field two
    // lines down says outright that no such span exists. Every consumer of
    // this figure - The Project header stat, the reporters' fact sheet -
    // inherited the claim from here, so the homepage fix alone left three
    // other places still making it. A slash separates; a dash spans.
  ...
  },
  {
    ...
    // CCSD 46 is not one of the eight districts the Village FAQ names, and the
    // page that renders this qualifier lists all eight a few hundred pixels
    // below it. Naming a ninth district contradicts the site's own source in
    // the same viewport. Same error class as the uncited levy table removed
    // earlier; it survived here in a qualifier string.
    qualifier: 'four of the eight are not Grayslake districts',
