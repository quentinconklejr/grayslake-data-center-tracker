          ...
          <div className="bg-gray-100 border-b border-gray-300 px-4 py-2.5 flex items-center justify-between gap-3">
            ...
            <div className="shrink-0 flex items-center gap-3">
              <a href={sources.villagefaq_archived.url} target="_blank" rel="noopener noreferrer"
                 className="text-2xs font-mono text-blue-600 hover:text-blue-800 transition-colors">Archived copy</a>
              <a href={sources.villagefaq_archived.localCopy} target="_blank" rel="noopener noreferrer"
                 className="text-2xs font-mono text-blue-600 hover:text-blue-800 transition-colors">PDF mirror</a>
            </div>
          </div>
