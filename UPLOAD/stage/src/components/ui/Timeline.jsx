              ...
              {showProjectedDivider && (
                <div className="relative flex items-center gap-3 py-5 pl-9">
                  <div className="absolute left-0 w-5 flex justify-center" aria-hidden="true">
                    <span className="block w-2 h-2 rounded-full bg-white ring-2 ring-gray-300" />
                  </div>
                  <span className="text-2xs font-mono font-semibold uppercase tracking-widest text-gray-500 whitespace-nowrap">
                    Projected &mdash; has not happened
                  </span>
                  <span className="flex-1 border-t border-dashed border-gray-300" aria-hidden="true" />
                </div>
              )}
              {proportional && i > 0 && (
